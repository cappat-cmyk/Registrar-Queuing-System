...
<head>
    ...
    <title>Report Generation & Import</title>
</head>
<body>
<div class="container">
        <div class="jumbotron">
                        ...
                        <div class="form-group col">
                            ...
                            <select class="form-select form-control" aria-label=".form-select-sm example" id="EvaluatorsOption" name="EvaluatorsOption">
                                  <?php
                                        ...
                                        $result = $conn->query("SELECT First_Name, Last_Name, CounterNumber, Role FROM users where Role='Evaluator' ORDER BY CounterNumber ASC");
