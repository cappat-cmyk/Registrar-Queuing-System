 ...
 <!-- Hanggang dito yung dropwdown and banner -->
        ...
        <script>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-3">
                <button type="submit" id="btn_save" name="btn_save" class="btn btn-primary  shadow rounded"  disabled onclick="customer_saveTransaction()">Save & Send</button>
...
<div class="jumbotron" id="claim-table">
            ...
            <div class="card">
                ...
                <?php
                            ...
                            $query_run = mysqli_query($conn, $query);
                        ?>
                       <div id="claim_tblcontents" style="max-height: 300px; overflow-y: scroll;">
                    <table id="datatableid" class="table datatableid">
