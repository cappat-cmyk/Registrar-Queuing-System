...
<a><img role="button" src="../IMAGES/UPHSL logo.png" class="mt-2 float-end icon-size1 "></a>
    
</div>

    <h1 class="lead display-3 text-center fw-bold mt-5">Transaction type</h1>
  ...
  <div class="d-flex justify-content-center align-items-center text-center" style="width:100%;">
        <div class="row row-cols-3 row-cols-lg-3 align-items-stretch g-4 py-5">
          ...
          <!-- div for consult/inquiries -->
          <button type="button" class="col" id="inquiries" data-bs-toggle="modal" value="inquiries">
            <div class="p-3">
                <img class="img-fluid" src="../images/consult.png"><br>
                <span class="text-white">Consult/Inquiries</span>
            </div>
          </button>
        ...
        <div class="modal-body">
          ...
          <input type="hidden" id="requesttype" name="requesttype">
            ...
            <div class="mb-3" id="StudentID">
              ...
              <input type="text" class="form-control" id="search" name="search" placeholder="Please type your StudentID (e.g. 19-0925-425)" required>
