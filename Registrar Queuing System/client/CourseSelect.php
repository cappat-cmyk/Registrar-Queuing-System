...
<a><img role="button" src="../IMAGES/Question mark icon.png" class="mt-2 img-fluid img-circle rounded float-end icon-size "></a>
    ...
    <?php
                    ...
                    $result = $conn->query("SELECT course_id, course FROM courselist ORDER BY course_id ASC");
