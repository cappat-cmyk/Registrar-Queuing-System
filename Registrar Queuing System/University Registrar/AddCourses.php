...
if(isset($_POST['updatedata'])){
    ...
    if(mysqli_num_rows($check_query_run) > 0) {
        ...
        $query = "UPDATE courselist SET CourseAbbr='$CourseAbbr', Course='$Course', Evaluator_id='$EvaluatorId' WHERE course_id='$course_id'";
        $query_run = mysqli_query($conn, $query);
...
if(isset($_POST['deletedata'])) {
    ...
    $query = "DELETE FROM courselist WHERE Course_id='$course_id'";
    $query_run = mysqli_query($conn, $query);
